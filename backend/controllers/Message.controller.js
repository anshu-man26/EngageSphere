...
export const sendMessage = async (req, res) => {
	try {
		...
		console.log("🔌 Receiver socket ID:", receiverSocketId ? receiverSocketId : "Not found (offline)");
		
		if (receiverSocketId) {
			// User is online, send socket notification
			console.log("✅ Recipient is online, sending socket notification");
			io.to(receiverSocketId).emit("newMessage", newMessage);
		} else {
			// User is offline, send email notification
			console.log("📧 Recipient is offline, checking for email notification...");
			...
			const notificationResult = await sendOfflineNotification(
				receiverId,
				senderId,
				conversation._id,
				newMessage.message
			...
			console.log("📊 Offline notification result:", notificationResult);
			if (notificationResult) {
				console.log("✅ Email notification sent successfully");
			} else {
				console.log("⏰ Email notification not sent (cooldown active or error)");
			}
		}
