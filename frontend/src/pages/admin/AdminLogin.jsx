			...
			<div className='max-w-md w-full space-y-8'>
				<div>
					...
					<p className='mt-2 text-center text-sm text-gray-400'>
						{showOtpInput ? `Enter the OTP sent to ${email}` : "Enter your admin credentials to continue"}
					</p>
				</div>
				...
				{!showOtpInput ? (
					<form className='mt-8 space-y-6' onSubmit={handleSubmit}>
						...
						{error && (
							<div className='bg-red-900 border border-red-700 text-red-200 px-4 py-3 rounded relative'>{error}</div>
						)}
						...
						<div className='text-center space-y-2'>
							<button type='button' onClick={goHome} className='text-gray-400 hover:text-white text-sm block w-full'>
								← Back to main site
							</button>
							<button type='button' onClick={goForgotPassword} className='text-gray-400 hover:text-white text-sm block w-full'>
								Forgot Password?
							</button>
						</div>
					</form>
					...
					<form className='mt-8 space-y-6' onSubmit={handleOtpSubmit}>
						...
						<div className='text-center'>
							<button type='button' onClick={handleBackToLogin} className='text-gray-400 hover:text-white text-sm'>
								← Back to login
							</button>
						</div>
					</form>
